...
/**
 * Test for /strategery/{id}
 */
Test('/strategery/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getStrategeryById get operation', function (t) {
            Mockgen().requests({
                path: '/strategery/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/strategery/{id}']['get']['responses']['200']['schema']);
